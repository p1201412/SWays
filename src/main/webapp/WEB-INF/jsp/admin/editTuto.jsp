                ...
                <div class="wrapper"><!-- wrapper needed for scroll -->
                    <div class="main clearfix">
                        <center>
                            ...
                            <h1>Edition of Tutorials</h1>

                            <c:url var="viewUsrUrl" value="/admin/viewTuto.html" />
                            <h1>Update ${tuto.authorName}'s tuto</h1>
                            ...
                            <c:url var="UpdateTutoUrl" value="/admin/updateTuto/${tuto.id}/" />
                            <form:form role="form" modelAttribute="tuto" method="POST" action="${UpdateTutoUrl}">
                                ...
                                <button type="submit" class="btn btn-default">Update Tutorial</button><br/><br/>
